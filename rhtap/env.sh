...
export IMAGE_URL=${IMAGE_URL-tssc-quay-quay-tssc-quay.apps.cluster-nv5j6.nv5j6.sandbox977.opentlc.com/tssc/rhtap-qe-java-quarkus:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-test-organization-jk/yrilliwfh-java-quarkus-gitops
